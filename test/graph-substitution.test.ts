...
import {
  findBlankNodes, isSubstituableGraph,
  rebuildBlankNodes
} from "../src/graph-substitution";
import { strictEqualityCheck } from '../src/test-util';

const ex = rdfNamespace("http://ex.org/", { factory: N3.DataFactory });
const { quad, blankNode } = N3.DataFactory;
